				...
				<div class="row">
					<div class="col-sm-3 col-md-2 sidebar">
						<ul class="nav nav-sidebar">
							...
							<li class="active"><a href="polls.php">Polls</a></li>
				...
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							...
							<h4 class="modal-title" id="modalRemoveLabel">Remove Poll</h4>
						</div>
						<div class="modal-body">
							Are you sure you want to remove this poll?
						</div>
						<div class="modal-footer">
							<button type="button" class="btn btn-danger btnConfirmRemove">Confirm</button>
